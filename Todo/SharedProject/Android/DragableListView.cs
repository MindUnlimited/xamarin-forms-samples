...
namespace DragableListView
{
    public class DragableListView : ListView, ITypeEvaluator, GestureDetector.IOnGestureListener
    {
        ...
        public DragableListView(Context context, IAttributeSet attrs, int defStyle)
            : base(context, attrs, defStyle)
        {
            init(context);
        }

        public DragableListView(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
            init(context);
        }
