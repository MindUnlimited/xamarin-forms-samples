...
public class DynamicListView : ListView 
{
    ...
    private bool mCellIsMobile = false;
    private bool mIsMobileScrolling = false;
    private int mSmoothScrollAmountAtEdge = 0;

    private readonly  int INVALID_ID = -1;
    ...
    private readonly  int INVALID_POINTER_ID = -1;
    ...
    public DynamicListView(Context context, global::Android.Util.IAttributeSet attrs, int defStyle) :base(context, attrs, defStyle) {
        init(context);
    }

    public DynamicListView(Context context, global::Android.Util.IAttributeSet attrs) :base(context, attrs) {
        init(context);
    }
    ...
    //            public bool onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
    //                mTotalOffset = 0;
    ...
    private void handleCellSwitch() {
        ...
        bool isBelow = (belowView != null) && (deltaYTotal > belowView.getTop());
        bool isAbove = (aboveView != null) && (deltaYTotal < aboveView.getTop());
     ...
     * readonly location when the user lifts his finger by modifying the
     * BitmapDrawable's bounds.
     */
    private readonly static TypeEvaluator<Rect> sBoundEvaluator = new TypeEvaluator<Rect>() {
